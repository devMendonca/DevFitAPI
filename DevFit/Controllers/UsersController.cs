using DevFit.Core.Entities;
using DevFit.Models.InputModels;
using DevFit.Models.ViewModels;
using DevFit.Persistencia;
...
namespace DevFit.Controllers
{
    // api/users
    [Route("api/[controller]")]
    public class UsersController : ControllerBase
    {
        private readonly DevFitDbContext _dbContext;
        public UsersController(DevFitDbContext dbContext)
        {
        ...
        public IActionResult Get(int id)
        {
            ...
            var userViewModel = new UserViewModel (user.Id, user.FullName, user.Height, user.Weight);
